class Ghost {
    constructor(x, y, width, height, speed, draw, imageX, imageY, imageWidth, imageHeight, range) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    draw() {
        ...
        canvasContext.drawImage(
            ghostFrames, this.imageX, this.imageY, this.imageWidth, this.imageHeight, 0, oneBlockSize, oneBlockSize, this.x, this.y, this.width, this.height
        );
